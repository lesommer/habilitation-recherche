...
Une première route possible pour une cascade directe de l'énergie cinétique de méso-échelle vers les échelles dissipatiove pourrait donc être liée à l'intense activité frontale à submesoéchelle dans les couches de surface de l'océan. Cette dynamique quasi-équilibrée et intensifié en surface partage beaucoup de similarité avec la dynamique quasi-geostrophique à plus grande échelle ou à l'interieur de l'océan. Il semblerait toutefois que ce régime de Charney puisse être associé à une intense cascade directe [@doi:10.1175/2008JPO3810.1;@doi:10.1038/ncomms6636]. De nombreux travaux récent ayant par ailleurs montré la très forte saisonnalité de cette dynamique frontale, tant sur la base de  modèles numériques  [@doi:10.1038/ncomms6636;@doi:10.1002/2016GL071349;@doi:10.1016/j.ocemod.2015.05.002] que d'observations [@doi:10.1038/ncomms7862;@doi:10.1175/JPO-D-15-0170.1;@doi:10.1002/2016GL068009], la question de la saisonalité des échanges d'énergie cinétique apparait donc assez centrale   [@doi:10.1029/2019MS001724;@doi:10.1029/2020GL087388;@doi:10.1007/s10236-017-1083-y]

Une deuxième route possible pour une cascade directe de l'énergie cinétique de méso-échelle pourrait impliquer des interactions entre mouvement quasi-équilibrés et mouvement hors équilibres (ondes interne, oscillation inertielles). Plusieurs mécanismes impliquant des ondes proches inertielles (voir [@doi:10.1146/annurev-marine-010814-015746]) ont été identifiés au cours des dernieres années [@doi:10.1017/jfm.2020.510;@doi:10.1017/jfm.2019.465;@doi:10.1103/PhysRevFluids.5.014801;@doi:10.1017/jfm.2018.308]. Il s'agit pour l'instant de mécanismes théoriques liés à des configurations d'écoulements particulières, certains impliquant des forcage externes (vents, ondes internes) mais une image générale semble déjà émerger (voir par exemple le très bonne synthèse de [@doi:10.1007/s10236-017-1088-6]). Ces mécanismes pose évidemment la question de l'intéractions avec les ondes internes de manière générale, en premier lieu desquelles les ondes de marée interne. Là encore, la forte saisonalité de l'expression de surface de la marée interne laisse supposer que les échanges énergetique qui l'impliquerait pourrait eux aussi dependre de la saison  [@doi:10.1029/2018GL081848]. 

Au moment ou nous avons commencé nos travaux sur ces questions, la question de l'existence d'une cascade directe était encore hypothétique ou tout au moins fondée sur des considerations relativement théoriques. La possibilité de déployer des modèles réalistes résolvant simultanément une fraction du spectre de la marée interne et une partie de la  dynamique de submesoéchelle ouvrait alors la possibilité d'aborder ces questions en termes quantitatifs et de confronter les différent mécanisme identifié dans un contexte réaliste. Ces travaux permettent en tout cas de préparer l'étude de ces questions sur la bases de données très attendue de la future mission altimétrique SWOT [@doi:10.1029/2019GL083675].


### Positionnement et approche générale

Le travail que nous avons engagé sur ces thématiques s'incrit donc dans le contexte particulier de l'émergence entre 2010 et 2015 de modèles de circulation capables de décrire de manière "réaliste" la dynamique de submeso-échelle à l'échelle du bassin océanique. Ces développements étaient largement motivés par la perspective de l'altimétrie à large fauchée (études d'observabilité pour la mission SWOT) et rendus possibles par l'évolution des calculateurs. Ce sont ces simulations, comme par exemple les simulations japonaise OFES entre 2011 et 2014 ou la simulation MITgcm-LLC4320 en 2015, qui ont permis de mettre en lumière la saisonnalité l'importance de la saisonnalité de la dynamique de submeso-échelle. toutefois, il faut noter que 
...
Plus generalement, cette phase de travail motive pour intercomparaison plus systematique des modeles (contexte AdAC), comprehension dynamique ageostrophique. et pour avancer vers couplage fine echelles dont on sait qu'il affecte les correlation entre variables à fine echelle. 
